...
public class WhenVerifyingATokenForAUriAndAChannelAlias {
  ...
  void theTokenMatchesTheExpectedValue() {
    Assert.assertEquals(token, "DIGEST:");
  }
  ...
  void theTokenSuccessfullyVerifiesWithTheCorrectSecret() {
    ...
    Assert.assertEquals(result.getValue().getString("uri"), "https://my-custom-backend.example.org");
