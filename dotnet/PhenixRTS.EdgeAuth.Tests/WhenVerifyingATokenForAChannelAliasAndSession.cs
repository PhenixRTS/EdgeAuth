...
{
    public sealed class WhenVerifyingATokenForAChannelAliasAndSession
    {
        private readonly string _token;

        public WhenVerifyingATokenForAChannelAliasAndSession()
        {
        ...
        {
            Assert.Equal("DIGEST:", _token);
        }
